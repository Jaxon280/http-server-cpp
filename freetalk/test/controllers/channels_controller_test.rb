...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { belongs_id: @channel.belongs_id, name: @channel.name, room_id: @channel.room_id } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { belongs_id: @channel.belongs_id, name: @channel.name, room_id: @channel.room_id } }
